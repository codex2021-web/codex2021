...
import cloud.thoughtspotstaging.champagne.http.request.*;
import cloud.thoughtspotstaging.champagne.http.response.HttpResponse;
import cloud.thoughtspotstaging.champagne.http.response.HttpStringResponse;
    ...
    private okhttp3.OkHttpClient getDefaultOkHttpClient() {
        if (defaultOkHttpClient == null) {
            synchronized (syncObject) {
                if (defaultOkHttpClient == null) {
                    //String credential = Credentials.basic("tsadmin", "admin");
                    defaultOkHttpClient = new okhttp3.OkHttpClient.Builder()
                            ...
                            //.addInterceptor(basicAuth("tsadmin", "admin"))
